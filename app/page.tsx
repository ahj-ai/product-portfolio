      ...
      <div className="flex min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        >
          ...
          <button
            ...
            className="absolute -right-3 top-8 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-full p-1 border border-slate-700 transition-colors z-10"
          >
                  ...
                  <CardContent className="p-8">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-lg text-slate-300 mb-4 text-pretty leading-relaxed">
                          Transforming complex problems into elegant AI-powered solutions. I've driven $10M+ in ARR, led
                          products that improved conversion by 30% YoY, and built platforms from 0→1 that serve
                          thousands of users.
                        </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="border-slate-800/50 bg-slate-900/50 backdrop-blur-xl hover:border-blue-500/50 transition-all duration-300">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-semibold text-white mb-4">MathStack AI</h3>
                    <p className="text-slate-400 mb-6">
                ...
                <Card className="border-slate-800/50 bg-slate-900/50 backdrop-blur-xl hover:border-purple-500/50 transition-all duration-300">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-semibold text-white mb-4">PickTrckr</h3>
                    <p className="text-slate-400 mb-6">
                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-6">
                      <div className="flex-1">
                        <div className="text-sm text-blue-400 mb-2">2024 - Present</div>
                        <h3 className="text-2xl font-semibold text-white mb-2">Founder</h3>
                        <h4 className="text-xl text-blue-400 mb-4">MathStack AI</h4>
                        <ul className="space-y-2 text-slate-400">
                ...
                <Card className="border-slate-800/50 bg-slate-900/50 backdrop-blur-xl">
                  <CardContent className="p-8">
                    <div className="flex items-start gap-6">
                      <div className="flex-1">
                        <div className="text-sm text-purple-400 mb-2">2023 - Present</div>
                        <h3 className="text-2xl font-semibold text-white mb-2">Product Lead</h3>
                        <h4 className="text-xl text-purple-400 mb-4">InterRoom</h4>
                        <ul className="space-y-2 text-slate-400">
                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-6">
                      <div className="flex-1">
                        ...
                        <h4 className="text-xl text-cyan-400 mb-4">Nimble RX</h4>
                        <ul className="space-y-2 text-slate-400">
                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-6">
                      <div className="flex-1">
                        ...
                        <h4 className="text-xl text-green-400 mb-4">Shopkick</h4>
                        <ul className="space-y-2 text-slate-400">
                          <li>
